    ...
    sealed class ModelTestModule : ModuleBase {
        public ModelTestModule() {
            ...
            foreach (var type in new[] { typeof(ModelTestCustomer), typeof(ModelTestLine), typeof(ModelTestOrder), typeof(ModelTestContact),
                         typeof(ModelTestStrictBroken), typeof(ModelTestDegradedBroken), typeof(ModelTestShipment), typeof(ModelTestParcel), typeof(ModelTestTicket), typeof(ModelTestBanded), typeof(ModelTestTwoBands), typeof(ModelTestNestedBands), typeof(ModelTestTiedBands), typeof(ModelTestServiceOrder) })
