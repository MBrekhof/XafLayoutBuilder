...
## Runtime Model Editor

Moved with the add-on to [XafModelEditor](https://github.com/MBrekhof/XafModelEditor) on 2026-09-20
(MODELEDITOR-012); the findings are that repository's `docs/api-notes.md`. Nothing here depends on them.
